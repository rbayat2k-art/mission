...
CREATE TABLE IF NOT EXISTS mission_steps (
  ...
  title VARCHAR(255) NOT NULL,
  action_type VARCHAR(40) NOT NULL DEFAULT 'other',
  description TEXT NOT NULL,
  requires_location TINYINT(1) NOT NULL DEFAULT 1,
  destination_name VARCHAR(255) NULL,
  evidence_requirement VARCHAR(40) NOT NULL DEFAULT 'none',
  deadline VARCHAR(64) NULL,
  deadline_at VARCHAR(40) NULL,
  ...
  created_at VARCHAR(40) NOT NULL,
  updated_at VARCHAR(40) NOT NULL,
  UNIQUE KEY uq_mission_step_no (mission_id, step_no),
  INDEX idx_mission_steps_status (mission_id, status, step_no),
  CONSTRAINT fk_mission_steps_mission FOREIGN KEY (mission_id) REFERENCES missions(id) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
-- statement-breakpoint
CREATE TABLE IF NOT EXISTS mission_step_segments (
  id CHAR(36) PRIMARY KEY,
  mission_id CHAR(36) NOT NULL,
  mission_step_id CHAR(36) NOT NULL,
  user_id CHAR(36) NOT NULL,
  ...
  end_location_recorded_at VARCHAR(40) NULL,
  created_at VARCHAR(40) NOT NULL,
  INDEX idx_step_segments_step_time (mission_step_id, started_at, ended_at),
  INDEX idx_step_segments_user_time (user_id, started_at, ended_at),
  CONSTRAINT fk_step_segments_mission FOREIGN KEY (mission_id) REFERENCES missions(id) ON DELETE CASCADE,
